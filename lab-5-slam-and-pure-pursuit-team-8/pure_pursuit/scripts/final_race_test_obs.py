...
x_start, x_end = 260, 270  # X coordinates
y_start, y_end = 180, 200  # Y coordinates
white_threshold = 200
img_array[x_start:x_end, y_start:y_end][img_array[x_start:x_end, y_start:y_end] > white_threshold] = 0

x_start, x_end = 95, 105
y_start, y_end = 210, 220
img_array[x_start:x_end, y_start:y_end][img_array[x_start:x_end, y_start:y_end] > white_threshold] = 0

x_start, x_end = 170, 180
y_start, y_end = 125, 140
img_array[x_start:x_end, y_start:y_end][img_array[x_start:x_end, y_start:y_end] > white_threshold] = 0

x_start, x_end = 265, 275
y_start, y_end = 70, 80
img_array[x_start:x_end, y_start:y_end][img_array[x_start:x_end, y_start:y_end] > white_threshold] = 0
...
#modified_image_path = "/home/yihsuan/sim_ws/src/f1tenth_gym_ros/maps/final_race_obs3.pgm"
